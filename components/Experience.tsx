    ...
    <section id="experience" className="relative py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <p className="text-indigo text-xs font-bold tracking-[0.14em] uppercase mb-3">Career Journey</p>
          ...
          <div className="space-y-10">
            {EXPERIENCES.map((exp, i) => (
              ...
              >
                ...
                <motion.div
                  whileHover={{ borderColor: "rgba(99,102,241,0.3)", boxShadow: "0 4px 28px rgba(99,102,241,0.07)" }}
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3 mb-1">
                      <div>
                        ...
                        <p className="font-bold text-cyan text-base mt-0.5">{exp.company}</p>
                        <p className="text-text-dim text-sm italic mt-0.5">{exp.project}</p>
                        <p className="text-text-dim text-xs mt-0.5">📍 {exp.location}</p>
                      </div>
                      <span className="shrink-0 text-xs font-semibold text-indigo bg-indigo/10 border border-indigo/20 px-3 py-1 rounded-full">
                        {exp.date}
                      </span>
                    </div>
